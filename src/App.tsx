...
const clientId =
  "BGuBx89xjIoqSfGJ9lpzFmKERiX0tY0OknUhozpHMwAlV5V22lLrkJjLfpoXmWGXDE4r7L07KfthVV30VtrtfZE";
...
const authAdapter = new AuthAdapter({
  adapterSettings: {
    ...
    loginConfig: {
      jwt: {
        verifier:
          import.meta.env.VITE_W3A_VERIFIER_NAME || "w3a-telegram-oauth-demo",
        typeOfLogin: "jwt",
        clientId,
      },
    },
...
function App() {
  ...
  const login = async () => {
    const URL =
      ...
      "https://w3a-telegram-server.vercel.app";
